...
class StoreBookRequest extends FormRequest
{
    ...
    {
        $this->merge([
            'is_available_print' => $this->boolean('is_available_print', true),
            'is_available_digital' => $this->boolean('is_available_digital', false),
            'loan_duration_days' => $this->loan_duration_days ?? 14,
        ]);
    }
